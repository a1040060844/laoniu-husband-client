...
- Needs device review: wife hero framing, status-card overlap on short phones, task publisher hero crop, review-card density, decree-card density, gold tab touch feel, dark input contrast, picker values, form ergonomics, and review actions after repeated state changes.
