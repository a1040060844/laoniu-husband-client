...
- Remote login stage mode positions husband, wife, cat-blue and cat-white as independent actors over the room background with bottom H5 card-image buttons, instead of embedding actors inside the local-mode cards.
