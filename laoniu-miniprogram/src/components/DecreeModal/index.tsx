...
export function DecreeModal({ decree, onAcknowledge }: { decree?: DecreeEvent | null; onAcknowledge: () => void }) {
  ...
  return (
    <View className="modal-layer">
      <View className="panel">
        ...
        <Button className="btn section" onClick={onAcknowledge}>领旨</Button>
      </View>
    </View>
  );
}
